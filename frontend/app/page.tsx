    ...
    <div className="min-h-screen bg-white dark:bg-gray-950 text-gray-900 dark:text-white">
      ...
      <nav className="fixed top-0 inset-x-0 z-50 border-b border-gray-200/80 dark:border-gray-800/80 bg-white/80 dark:bg-gray-950/80 backdrop-blur-md">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-14 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-6 text-sm text-gray-600 dark:text-gray-400">
            ...
            <a href="https://github.com/AKIB473/inkvault" target="_blank" rel="noopener" className="hover:text-gray-900 dark:hover:text-white transition-colors">GitHub ↗</a>
          </div>
      ...
      <section className="pt-32 pb-20 px-4 text-center">
        ...
        <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-3">
          ...
          <a href="https://github.com/AKIB473/inkvault" target="_blank" rel="noopener">
      ...
      <footer className="border-t border-gray-200 dark:border-gray-800 py-10 px-4">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-gray-400">
          ...
          <div className="flex items-center gap-5">
            ...
            <a href="https://github.com/AKIB473/inkvault" target="_blank" rel="noopener" className="hover:text-gray-600 dark:hover:text-gray-200 transition-colors">GitHub</a>
          </div>
        </div>
      </footer>
    </div>
